 ...
 <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10"> 
            ...
            <input type="text" name = "price" id="price" placeholder="Enter Price in Rs.">

            <label class="label" for="area"> House Size </label>
            <input type="text" name = "area" id ="area" placeholder="Enter Size in Sq Ft.">
            ...
            <textarea name = "description" id="description" placeholder="Enter Short Description of What You Are Selling i.e. 2 Bathrooms, 2 Bedrooms etc."></textarea>

            <label class="label" for="location"> Location </label>
            <input type="text" name = "location" id="location" placeholder="Enter Address of Property"></input>
